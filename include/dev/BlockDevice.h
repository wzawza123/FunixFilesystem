/**
 * @ Author: wzawza123
 * @ Create Time: 2023-03-25 20:24:42
 * @ Modified by: wzawza123
 * @ Modified time: 2023-03-25 21:35:51
 * @ Description: 本文件用于定义块设备基类BlockDevice以及派生类ATA磁盘设备类ATABlockDevice
 */
...
public:
	BlockDevice();	//构造函数
	BlockDevice(Devtab* tab);	//使用快设备表tab初始化
